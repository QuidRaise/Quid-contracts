...
interface IInvestorStore {
    ...
    function getAmountInvestorHasSpent(address investorAddress, address paymentCurrencyAddress) external view returns (uint256);
    ...
    function investedInRound(address investorAddress, uint256 roundId) external view returns (bool);
}
