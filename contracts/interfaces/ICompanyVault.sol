...
interface ICompanyVault {
     ...
     */
    function depositCompanyTokens(uint companyId) external;
    /**
     ...
     */
    function depositPaymentTokensToVault(uint companyId,address tokenContractAddress) external;
     ...
     */
    function withdrawPaymentTokensFromVault(uint companyId,address tokenContractAddress, uint amount) external;
