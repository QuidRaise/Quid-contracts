...
contract Config is IConfig {
    ...
    function getNumericConfig(bytes32 key) external override view returns (uint256)
    {
        return _numericConfigManager[key] ;
    }

    function getCharacterConfig(bytes32 key) external override  view returns (string memory)
    {
